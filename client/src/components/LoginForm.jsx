...
export function LoginForm({ onSwitchToSignup }) {
    ...
    return (
        <form className="auth-form" onSubmit={handleSubmit} noValidate>
            ...
            <a href="http://localhost:3000/auth/github" className="github-button auth-form-button">
            ...
            <a href="http://localhost:3000/auth/google" className="gsi-material-button">
            ...
            <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-md border border-(--border) bg-transparent py-2.5 text-(--text-h) transition-opacity hover:opacity-80 disabled:cursor-default disabled:opacity-60"
            >
                {guestSubmitting && <Spinner size={16} />}
